-- ==================================================================================
-- STOCK MANAGEMENT SYSTEM - COMPLETE MIGRATION (VARCHAR VERSION)
-- ==================================================================================
-- This migration creates all tables for inventory tracking, batch management,
-- stock adjustments, and ledger entries using VARCHAR instead of ENUMs.
...
CREATE TABLE stock_adjustment (
    ...
    -- Changed from ENUM to VARCHAR(50)
    adjustment_type VARCHAR(50) NOT NULL, -- Values: DAMAGE, EXPIRED, etc.

    -- Changed from ENUM to VARCHAR(50) AND Renamed column as requested
